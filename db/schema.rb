...
ActiveRecord::Schema[8.1].define(version: 2026_07_24_112827) do
  ...
  create_table "albums", force: :cascade do |t|
    t.text "about"
    t.boolean "ai_policy", default: false, null: false
  ...
  create_table "followings", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["artist_id"], name: "index_followings_on_artist_id"
  ...
  create_table "releases", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["album_id"], name: "index_releases_on_album_id", unique: true
